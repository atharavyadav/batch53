...
//     async function (firstname, lastname, phone, email,Country) {
//         const page = browserManager.getPage(); // Get the shared page instance
//         await RegisterUser.entercontactInformation(page, firstname, lastname, phone, email,Country); // Pass the page instance
//     }
// );

// When(
//     'the user enters contact information {string} {string} {string} {string} {string}',
//     async function (firstname, lastname, phone, email,Country) {
//         const page = browserManager.getPage(); // Get the shared page instance
//         await RegisterUser.entercontactInformation(page, firstname, lastname, phone, email,Country); // Pass the page instance
//     }
